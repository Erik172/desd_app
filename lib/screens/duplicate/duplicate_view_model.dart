...
class DuplicateViewModel extends ChangeNotifier {
  ...
  Future<void> processFiles(BuildContext context) async {
    ...
    final allowedExtensions = {'pdf',  'tif', 'tiff'};
    ...
    final uri = Uri.parse('${await Constants.apiBaseUrl}/api/v1/duplicate');
  ...
  Future<void> _handleResponse(http.StreamedResponse response, BuildContext context) async {
    ...
    if (response.statusCode == 202) {
      _showSnackBar(context, 'Tarea Agregada al sistema. Puede revisar el progreso en la sección de resultados.');
